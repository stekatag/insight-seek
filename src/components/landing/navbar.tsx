...
export const Navbar = ({ currentPath = "/" }: NavbarProps) => {
  ...
  return (
    <header className="shadow-inner bg-opacity-15 w-[90%] md:w-[70%] lg:w-[75%] lg:max-w-(--breakpoint-xl) top-5 mx-auto sticky border dark:border-secondary z-40 rounded-2xl flex justify-between items-center p-2 bg-card">
